 ...
 */
function get_<div class="sidebar">
		<?php get_sidebar(); ?>
	</div>( $args = array() ) {
 ...
 * @since 4.1.0
 *
 * @param array $args Optional. See get_<div class="sidebar">
		<?php get_sidebar(); ?>
	</div>() for available arguments.
 *                    Default empty array.
 */
function <div class="sidebar">
		<?php get_sidebar(); ?>
	</div>( $args = array() ) {
	echo get_<div class="sidebar">
		<?php get_sidebar(); ?>
	</div>( $args );
}
